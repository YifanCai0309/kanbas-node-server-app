    ...
    lessons: [
      {
        ...
        description: "Introduction to basic aerodynamic principles.",
        module: "M201",
      },
      {
        _id: "L402",
        name: "Fluid Dynamics",
        description: "Understanding fluid dynamics in an aerodynamic context.",
        module: "M201",
      },
      {
        _id: "L403",
        name: "Aerodynamic Forces",
        description: "Study of aerodynamic forces acting on bodies.",
        module: "M201",
      },
    ],
  },
    ...
    lessons: [
      {
        _id: "L501",
        name: "Subsonic Flow",
        description: "Principles and characteristics of subsonic flow.",
        module: "M202",
      },
      {
        _id: "L502",
        name: "Supersonic Flow",
        description: "Principles and characteristics of supersonic flow.",
        module: "M202",
      },
      {
        _id: "L503",
    ...
    lessons: [
      {
        ...
        description: "Understanding the mechanisms of aerodynamic heating.",
        module: "M203",
      },
      {
        _id: "L602",
        ...
        description:
          "Overview of thermal protection systems used in aerospace.",
        module: "M203",
      },
      {
        _id: "L603",
        name: "Heat Transfer",
        description: "Principles of heat transfer in aerodynamic contexts.",
        module: "M203",
      },
    ],
  },
  {
    ...
    lessons: [
      ...
      },
      {
        _id: "L702",
        name: "Load Analysis",
        description: "Understanding load analysis in spacecraft design.",
        module: "M301",
      },
      {
        _id: "L703",
        name: "Structural Integrity",
        description: "Ensuring structural integrity in spacecraft.",
        module: "M301",
      },
    ],
  },
    ...
    lessons: [
      {
        ...
        description: "Principles of orbital dynamics and motion.",
        module: "M302",
      },
      {
        _id: "L802",
        name: "Orbital Transfers",
        description: "Understanding orbital transfer maneuvers.",
        module: "M302",
      },
      {
        _id: "L803",
        name: "Mission Planning",
        description: "Basics of mission planning and execution.",
        module: "M302",
      },
    ],
  },
    ...
    lessons: [
      {
        ...
        description: "Integration of various spacecraft systems.",
        module: "M303",
      },
      {
        _id: "L902",
        name: "Subsystems Overview",
        description: "Detailed overview of spacecraft subsystems.",
        module: "M303",
      },
      {
        _id: "L903",
        name: "Testing and Validation",
        description: "Methods for testing and validating spacecraft systems.",
        module: "M303",
      },
    ],
  },
